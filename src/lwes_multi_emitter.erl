...
normalize_test_ () ->
  [
    ...
    <- [
         ...
         % TODO: support labels and sub-labels
         % {"127.0.0.1",9191} ->
         %    {"127.0.0.1",9191,[{label, abc}]} ->
         %      {1, group, [{"127.0.0.1",9191}], abc}
         %
         % {2,group,[{"127.0.0.1",9191},{"127.0.0.1",9292}]} ->
         %   {2, group, [{"127.0.0.1",9191},{"127.0.0.1",9292}], abc}
         %
         % {2, group, [{2, random, [{"127.0.0.1",30000},
         %                          {"127.0.0.1",30001},
         %                          {"127.0.0.1",30002}]},
         %             {lwes_emitter_stdout,[{label,stdout}]}
         %            ]
         % } ->
         % {2, group, [{2, random, [{"127.0.0.1",30000},
         %                          {"127.0.0.1",30001},
         %                          {"127.0.0.1",30002}], [{label,udp}]},
         %             {lwes_emitter_stdout,[{label,stdout}]}
         %            ], [{label, grid}]
         % }
