...
-define (LWES_N_U_INT_16_ARRAY, nuint16_array).
-define (LWES_N_INT_16_ARRAY,   nint16_array).
-define (LWES_N_U_INT_32_ARRAY, nuint32_array).
-define (LWES_N_INT_32_ARRAY,   nint32_array).
-define (LWES_N_STRING_ARRAY,   nstring_array).
-define (LWES_N_INT_64_ARRAY,   nint64_array).
-define (LWES_N_U_INT_64_ARRAY, nuint64_array).
-define (LWES_N_BOOLEAN_ARRAY,  nboolean_array).
-define (LWES_N_BYTE_ARRAY,     nbyte_array).
-define (LWES_N_FLOAT_ARRAY,    nfloat_array).
-define (LWES_N_DOUBLE_ARRAY,   ndouble_array).
